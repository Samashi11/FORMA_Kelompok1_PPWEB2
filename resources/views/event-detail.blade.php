<x-app-layout>
  <main class="bg-slate-50 min-h-screen font-sans">
    ...
    <section class="flex flex-col gap-6 px-10 py-12 bg-blue-100 rounded-lg mx-10 mt-6">
      <h1 class="text-4xl font-black text-[#0d151c]">Masa Depan Teknologi Ada di Sini</h1>
      <p class="text-base text-[#0d151c]">
        Bergabunglah dengan para inovator, pemimpin industri, dan pemikir visioner di TechConnect.
      </p>
      <button class="rounded-full bg-[#0b80ee] text-white h-10 px-4 text-sm font-bold w-max">Daftar Sekarang</button>
    </section>

    <!-- Tentang -->
    <section class="px-10 py-6">
      <h2 class="text-xl font-bold text-[#0d151c]">Tentang TechConnect</h2>
      <p class="mt-2 text-base text-[#0d151c]">
        TechConnect adalah konferensi teknologi tahunan yang mempertemukan para profesional dan penggemar teknologi. Hadirkan pembicara utama, sesi teknis, dan peluang jaringan.
      </p>
    </section>
    ...
    <section class="px-10 py-6">
      ...
      <div class="mt-4 flex flex-col gap-2 bg-white p-4 rounded-lg border">
        ...
        <p class="text-base font-bold text-[#0d151c]">Dr. Anya Sharma</p>
      ...
      <table class="w-full mt-4 table-auto border-collapse">
        ...
        <tbody>
          <tr class="border-t">
            ...
            <td class="px-4 py-2">Dr. Anya Sharma</td>
          </tr>
          <tr class="border-t">
