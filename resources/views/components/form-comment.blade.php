<form action="{{ route('save.comment') }}" method="POST" class="relative w-full">
    @csrf
    <input type="hidden" name="forum_id" value="{{ $forumId }}">
    <input type="text" name="comment"
        class="w-full py-3 px-5 pr-14 rounded-lg border border-gray-300 bg-white shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] focus:outline-none text-gray-900 placeholder-gray-400 text-lg font-normal leading-relaxed"
